<!-- BEGIN PAGE HEADER-->
			<div class="row">
				<div class="col-md-12">
					...
					<?php echo $this->element('admin-breadcrumb',array('pageName'=>'Menu_add'));?>
	...
	<div class="col-md-10 ">
		...
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-reorder"></i> Add CMS Menu
				</div>
				<div class="tools">
					<a
						href=""
...
$divotherstyle=(@$this->data['Menu']['web_page_url']=="other")?"":"display:none";
...
echo $this->Form->input ( 'page_url',
		array ("class" => "form-control",'type' => 'text',
				...
				"div" => array ("id" => "page_urls","class"=>"form-group","style"=>"display:none;"),
				'label' => array ('text' => 'Page URL','class' => '') ,
				'error' => array(
						'attributes' => array('wrap' => 'span', 'class' => 'help-block')
				)
...
echo $this->Form->input('staticlink',
		array(
			"options"=>array('categories' => 'Category Page','categories/catalog_request' => 'Category Page'),
				"class"=>"form-control",
				"id"=>"otherlink",
				'div'=>array('style'=>$divotherstyle, 'class'=>'form-group',"id"=>"pageotherlink"),
				'type'=>'select',
				'label'=>array('text'=>'Static Page Link','class'=>''),
				'error' => array(
								'attributes' => array('wrap' => 'span', 'class' => 'help-block')
								)
				));
