...
<div class="row-fluid">
			  <div class="span6" style="padding-top:10px; padding-left:10px;">
				   <?php 
				   echo $this->form->create("Users",array('url' => array('controller' => 'users', 'action' => 'driver_product',$this->request->params['pass'][0]), 'type' => 'get'));
			  ...
			  echo $this->form->input('date', array("class" => "form-control marBottom10 daterange active", 'type' => 'text',
			   ...
			   echo '</div>';
				   echo '<div class="span5 ">';
					...
					echo " &nbsp; ";
					echo $this->Form->button('Clear', array('type' => 'button', 'class' => 'btn btn-info custom-btn-index','onclick'=>isset($this->params->query['keyword'])?"window.location.href='" . $this->webroot . "admin/users/driver_product".$this->request->params['pass'][0]."'":""));
					echo "</div>";
				   echo $this->form->end();
				   ?>
		...
		<tr>
			...
			<th>
			 ...
			 <th>
			  ...
			  <th>
				  <strong><?php echo   $url = $this->Paginator->sort('Product.name','Product Name'); ?></strong>
			 </th>
