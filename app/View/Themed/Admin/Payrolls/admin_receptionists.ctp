...
<div class="row-fluid">
			  <div class="span6" style="padding-top:10px; padding-left:10px;">
				   ...
				   echo $this->form->create("Payroll",array('url' => array('controller' => 'payrolls', 'action' => 'receptionists'), 'type' => 'get'));
	...
	<tbody>
		...
		<tr>
		  ...
		  <?php echo $this->html->link('<i class="entypo-doc-text"></i>
					Payroll', array("controller" => "payrolls", "action" => "receptionist_payroll", $user['User']['id'], "admin" => true), array("class"=>"btn btn-info btn-sm btn-icon icon-left","escape" => false)); ?>
