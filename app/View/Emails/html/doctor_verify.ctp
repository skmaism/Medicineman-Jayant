...
<tr>
<td colspan="2" width="20%">You have registered as doctor.</td>
</tr>
<tr>
...
<br>
<a href="<?php echo FULL_BASE_URL.router::url('/',false); ?>doctors/verify/<?php echo MD5($p_id); ?>">Please click here to verify your Email </a>