 ...
 */
	//Configure::write('Routing.prefixes', array('admin'));
        Configure::write('Routing.prefixes', array('admin','doctor','patient'));
 ...
 */
	Configure::write('Security.salt', '519c46853db8310052dd5b0c0f761838daacfa7a');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '549870378583452328226798794515');
